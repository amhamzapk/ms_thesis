...
#define VCPU_cr3 2952 /* offsetof(struct vcpu, arch.cr3) */
...
#define DOMAIN_is_32bit_pv 684 /* offsetof(struct domain, arch.pv.is_32bit) */
...
#define DOMAIN_vm_assist 536 /* offsetof(struct domain, vm_assist) */
